<script>
  import PrevMatches from "./prevMatches.svelte";
   ...
   * @type {string}
   */
   export let accountCreation;
</script>

<div class="board">
  <svg class="account-picture" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
